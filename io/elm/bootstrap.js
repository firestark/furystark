...
var $author$project$Material$Icons$add = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
...
var $author$project$Material$Elevation$z6 = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'box-shadow', '0 3px 5px -1px rgba(0,0,0,.2), 0 6px 10px 0 rgba(0,0,0,.14), 0 1px 18px 0 rgba(0,0,0,.12)'));
var $author$project$Main$fab = function (theme) {
	return A2(
			...
			label: A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Background$color(theme.secondary),
						$mdgriffith$elm_ui$Element$Font$color(theme.onSecondary),
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$px(56)),
						$mdgriffith$elm_ui$Element$height(
						$mdgriffith$elm_ui$Element$px(56)),
						$author$project$Material$Elevation$z6
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
					$mdgriffith$elm_ui$Element$html($author$project$Material$Icons$add))),
			url: '/add'
		});
};
...
var $author$project$Material$Icons$highlight = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$d('M6,14l3,3v5h6v-5l3-3V9H6V14z M11,2h2v3h-2V2z M3.5,5.88l1.41-1.41l2.12,2.12L5.62,8L3.5,5.88z \n                    M16.96,6.59l2.12-2.12 l1.41,1.41L18.38,8L16.96,6.59z')
										]),
									_List_Nil)
								]))
						]))
...
var $author$project$Theme$highlight = F2(
	function (kind, alpha) {
		if (kind.$ === 'Light') {
			return A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, alpha);
		} else {
...
var $author$project$Material$List$twoElement = F3(
	function (theme, text1, text2) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							A2($author$project$Theme$highlight, theme.kind, 0.16))
						])),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							A2($author$project$Theme$highlight, theme.kind, 0.04))
						]))
				]),
			_List_fromArray(
				[
	...
	function (theme, item) {
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Font$color(theme.onBackground),
...
var $author$project$Material$TopAppBar$titleEl = function (txt) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Material$Elevation$z1 = $mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Material$TopAppBar$regular = F3(
	function (title, icon, theme) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$color(theme.primary),
					$mdgriffith$elm_ui$Element$Font$color(theme.onPrimary),
					$author$project$Material$Elevation$z1,
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'z-index', '100'))
				]),
			_List_fromArray(
				[
					$author$project$Material$TopAppBar$titleEl(title),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
var $author$project$Material$Card$view = F2(
...
var $author$project$Main$body = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(model.theme.background),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$fab(model.theme))
				]),
			_List_fromArray(
				[
					A3(
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$SwitchTheme),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'))
							]),
						$mdgriffith$elm_ui$Element$html($author$project$Material$Icons$highlight)),
					model.theme),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
