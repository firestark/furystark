<aside class="mdc-drawer mdc-elevation--z2">
    <div class="mdc-drawer__content">
        <nav class="mdc-list">
            <a class="mdc-list-item {{ ( strpos ( request::getUri ( )->getPath ( ), '/settings' ) === false ) ? 'mdc-list-item--activated' : '' }}" href="/">
                @if ( strpos ( request::getUri ( )->getPath ( ), '/settings' ) === false )
            ...
            <a class="mdc-list-item {{ ( request::getUri ( )->getPath ( ) === '/completed' ) ? 'mdc-list-item--activated' : '' }}" href="/completed">
            ...
            <a class="mdc-list-item {{ ( request::getUri ( )->getPath ( ) === '/settings' ) ? 'mdc-list-item--activated' : '' }}" href="/settings">
