<aside class="mdc-drawer mdc-elevation--z2">
    <div class="mdc-drawer__content">
        <nav class="mdc-list">            
            <a class="mdc-list-item {{ ( substr ( request::getUri ( )->getPath ( ), 0, 10 ) === '/exercises' ) ? 'mdc-list-item--activated' : '' }}" href="/exercises">
            ...
            <a class="mdc-list-item {{ ( substr ( request::getUri ( )->getPath ( ), 0, 8 ) === '/schemes' ) ? 'mdc-list-item--activated' : '' }}" href="/schemes">
