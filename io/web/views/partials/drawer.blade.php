<aside class="mdc-drawer mdc-elevation--z2">
    <div class="mdc-drawer__content">
        <nav class="mdc-list">
            <a class="mdc-list-item {{ ( request::getUri ( )->getPath ( ) === '/exercises' ) ? 'mdc-list-item--activated' : '' }}" href="/exercises">
            ...
            <a class="mdc-list-item {{ ( request::getUri ( )->getPath ( ) === '/schemes' ) ? 'mdc-list-item--activated' : '' }}" href="/schemes">
